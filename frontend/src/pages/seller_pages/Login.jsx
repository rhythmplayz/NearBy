...
const SellerLogin = () => {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            // Redirect to seller-specific home or dashboard
            setTimeout(() => navigate('/seller/dashboard'), 1500);
        } catch (err) {
            setNotification({ show: true, message: 'Login failed! Please check business credentials.', type: 'error' });
            console.error(err);
        }
    };
            ...
            <Container>
                <LoginBox>
                    ...
                    <p style={{ marginTop: '30px', fontSize: '14px', color: '#0D0D0D' }}>
                        Want to sell on NearBy? <StyledLink to="/seller/register">Register your business</StyledLink>
                    </p>
                </LoginBox>
            </Container>
            <Footer />
