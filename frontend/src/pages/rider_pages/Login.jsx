...
const RiderLogin = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      setNotification({ show: true, message: 'Login failed! Please check rider credentials.', type: 'error' });
      console.error(err);
    }
  };
      ...
      <Container>
        <LoginBox>
          ...
          <p style={{ marginTop: '30px', fontSize: '14px', color: '#0D0D0D' }}>
            New rider? <StyledLink to="/rider/register">Join as rider</StyledLink>
          </p>
        </LoginBox>
      </Container>
      <Footer />
